...
KERNEL_SPECS="oneplus3;cm;lineage15;http://kernel.boeffla.de/oneplus3/boeffla-kernel-lineage/;boeffla-kernel-#VERSION#-Lineage15.1-OnePlus3-anykernel.recovery.zip"
